// copied from datx-jsonapi https://github.com/infinum/datx/blob/master/packages/datx-jsonapi/src/consts.ts
export const MODEL_LINKS_FIELD = 'jsonapiLinks';
export const MODEL_REF_LINKS_FIELD = 'jsonapiRefLinks';
export const MODEL_REF_META_FIELD = 'jsonapiRefMeta';
export const MODEL_META_FIELD = 'jsonapiMeta';
export const MODEL_PERSISTED_FIELD = 'networkPersisted'; // Needs to be the same as in datx-network
