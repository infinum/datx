...
export interface ICollection {
    ...
    add<T extends Model>(data: IDictionary<any>, model: IType | {
        new (): T;
    }): T;
    add<T extends Model>(data: Array<IDictionary<any>>, model: IType | {
        new (): T;
    }): Array<T>;
    ...
    remove(model: IType | typeof Model, id?: IIdentifier): any;
