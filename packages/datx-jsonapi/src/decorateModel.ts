...
export function decorateModel<T extends PureModel>(BaseClass: IModelConstructor<T>): IModelConstructor<T, IJsonapiModel> {
  // @ts-ignore
  ...
  return JsonapiModel as unknown as IModelConstructor<T, IJsonapiModel>;
}
