import { MockBaseRequest, fetchReference } from './mock/MockBaseRequest';
import {
  addInterceptor,
  setUrl,
  collection,
...
import { PureModel, Attribute, Collection, Model } from '@datx/core';
